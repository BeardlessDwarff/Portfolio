...
Friend Class PrintPreviewControl
...
Label_00FF:
    ...
    Public Sub RefreshPreview()
        If (Not Me._doc Is Nothing) Then
            ...
            Catch ex As Exception
                MCSCTRLS2.Functions.Msgbox("Het is niet mogelijk een afdruk voorbeeld te laten zien." & vbCrLf & vbCrLf & "Mogelijk is de printer niet juist ingesteld op dit werkstation.", MsgBoxStyle.OkOnly + MsgBoxStyle.Critical, "Fout bij print voorbeeld")
            Finally
                Me._cancel = False
                Me._rendering = False
    ...
    Private Shadows Const MARGIN As Integer = 4 'Shadows toegevoegd ivm warning...

    ' Nested Types
    Friend Class DocumentPrinter
        Inherits PrintDocument
        ' Methods
        Public Sub New(ByVal preview As PrintPreviewControl, ByVal first As Integer, ByVal last As Integer)
            Me._first = first
            Me._last = last
