...
Public Class iTextSharpUtil
  ...
  Public Shared Function GetOptimalDPI(ByVal filepath As String, ByVal pageNumber As Integer, ByRef oPictureBox as MCSCTRLS1.PictureBox, Optional ByVal userPassword As String = "") As Integer
    GetOptimalDPI = 0
  ...
  Public Shared Sub fillRecursiveHTMLTree(ByVal arList As ArrayList, ByRef strHtml As String)
    ...
    For Each item As Object In arList
      Dim i As String = Regex.Replace(item("Page"), "(^\d+).+$", "$1")
            strHtml &= "<li><a href=""javascript:changeImage('images/page" & i & ".png')"">" & FrameworkNS.Functions.WEB.HtmlEncode(item("Title")) & "</a></li>"
      If Not Nothing Is item("Kids") Then
