...
Public Class ImageUtil
  ...
  Public Shared Sub ScaleImageToPicBox(ByRef oPict as MCSCTRLS1.PictureBox, ByRef img As Drawing.Image)
  ...
  Public Shared Sub RotateImageClockwise(ByRef pPicBox as MCSCTRLS1.PictureBox)
  ...
  Public Shared Sub RotateImageCounterclockwise(ByRef pPicBox as MCSCTRLS1.PictureBox)
  ...
  Public Shared Sub FlipDimensions(ByRef pPicbox as MCSCTRLS1.PictureBox)
  ...
  Public Shared Sub PictureBoxZoomActual(ByRef pPicBox as MCSCTRLS1.PictureBox)
  ...
  Public Shared Sub PictureBoxZoomPageWidth(ByRef pPicBox as MCSCTRLS1.PictureBox)
  ...
  Public Shared Sub PictureBoxZoomFit(ByRef pPicBox as MCSCTRLS1.PictureBox)
    If Not Nothing Is pPicBox And Not Nothing Is pPicBox.Parent Then
  ...
  Public Shared Sub PictureBoxZoomIn(ByRef pPicBox as MCSCTRLS1.PictureBox)
    If Not Nothing Is pPicBox And Not Nothing Is pPicBox.Parent Then
      PictureBoxCenter(pPicBox, (pPicBox.Width * 1.25), (pPicBox.Height * 1.25))
    End If
  End Sub

    Public Shared Sub PictureBoxZoomOut(ByRef pPicBox as MCSCTRLS1.PictureBox)
        If Not Nothing Is pPicBox Then
            PictureBoxCenter(pPicBox, (pPicBox.Width / 1.25), (pPicBox.Height / 1.25))
        End If
    End Sub

  Public Shared Sub PictureBoxCenter(ByRef oPictureBox as MCSCTRLS1.PictureBox, ByVal psWidth As Integer, ByVal psHeight As Integer)
    oPictureBox.Width = psWidth
    oPictureBox.Height = psHeight
    RecalcPageLocation(oPictureBox)
  End Sub

  Public Shared Sub RecalcPageLocation(ByRef oPictureBox as MCSCTRLS1.PictureBox)
    ...
    Dim PageLocation As New Point(oPictureBox.Location)
        Dim HorizontalScrollPosition As Integer = CType(oPictureBox.Parent, Object).HorizontalScroll.Value
        Dim VerticalScrollPosition As Integer = CType(oPictureBox.Parent, Object).VerticalScroll.Value
  ...
  Public Shared Sub PictureBoxZoomFitMany(ByRef pPicBox as MCSCTRLS1.PictureBox)
