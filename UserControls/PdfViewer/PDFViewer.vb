...
Public Class PDFViewer
  ...
  Private XPDFPrintingPicBox As new MCSCTRLS1.PictureBox
  ...
  Public Property FileName() As String
    ...
    Set(ByVal value As String)
            If value Is Nothing OrElse value = "" Then Return
...
OCRCurrentImage:
  ...
  End Sub
    ...
    Private Sub tsZoomOut_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsZoomOut.Click
        CurrentViewMode = ViewMode.USER_ZOOM
        Dim objPictureBox as MCSCTRLS1.PictureBox = FindPictureBox(mCurrentPageNumber)
...
GhostScriptFallBack:
    ...
    Private Sub InitViewModes()
        ...
        tscbZoom.Items.Add("Volledig scherm")
        tscbZoom.Items.Add("Volledige breedte")
        If ImageUtil.IsTiff(mPDFFileName) Then
            tscbZoom.Items.Add("100%")
    End If
  End Sub
  ...
  Private Sub InitializePageView(Optional ByVal Mode As ViewMode = ViewMode.FIT_TO_SCREEN)
    ...
    If mContinuousPages Then
      ...
      For i As Integer = 1 To mPDFPageCount
        Dim ObjPictureBox As new MCSCTRLS1.PictureBox
      ...
      Next
      Dim EndPictureBox As new MCSCTRLS1.PictureBox
  ...
  End Sub
    ...
    Private CurrentViewMode As ViewMode = ViewMode.FIT_WIDTH

    Private Sub ApplyZoom(ByVal Mode As ViewMode)

        If Mode = ViewMode.USER_ZOOM Then Return

        Dim oPictureBox as MCSCTRLS1.PictureBox = FindPictureBox("SinglePicBox")
        If oPictureBox Is Nothing Then Return
  ...
  Private Sub MakePictureBox1To1WithImage(ByRef oPictureBox as MCSCTRLS1.PictureBox, Optional ByRef newImage As Drawing.Image = Nothing)
  ...
  Private Sub AutoRotatePicBox(ByRef oPictureBox as MCSCTRLS1.PictureBox, ByRef newImage As Drawing.Image)
    Dim picHeight As Integer = oPictureBox.Height
    Dim picWidth As Integer = oPictureBox.Width
  ...
  Private Sub CenterPicBoxInPanel(ByRef oPictureBox as MCSCTRLS1.PictureBox)
    ImageUtil.RecalcPageLocation(oPictureBox)
  End Sub

  Private Delegate Sub ShowImage(ByVal sFileName As String, ByVal iFrameNumber As Integer, ByRef oPictureBox as MCSCTRLS1.PictureBox, ByVal XPDFDPI As Integer)
  ...
  Private Sub UpdatePageLabel()
        tsPageLabel.Text = "Pagina " & mCurrentPageNumber & " van " & mPDFPageCount
  ...
  Private Sub DisplayCurrentPage()
        Dim oPict as MCSCTRLS1.PictureBox = FindPictureBox(mCurrentPageNumber)
        ...
        If (mLastPageNumber <> mCurrentPageNumber) OrElse (oPict.Image Is Nothing) Then
            CheckPageBounds()
            UpdatePageLabel()
  ...
  '  Dim objPictureBox as MCSCTRLS1.PictureBox = FindPictureBox("SinglePicBox")
  ...
  Private Function FindPictureBox(ByVal controlName As String) as MCSCTRLS1.PictureBox
    If mContinuousPages Then
  ...
  Private Sub ClearAllPictureBoxes(ByVal StartingPageNumber As Integer, ByVal EndingPageNumber As Integer)
        ...
        EasyCare.Functions.MemoryManagement.StartGarbageCollection
    End Sub

  Private Sub ApplyToAllPictureBoxes(ByRef oControl As Control, ByVal Mode As ViewMode)
    Dim dummyPictureBox As new MCSCTRLS1.PictureBox
        Dim optimalDPI As Integer = 0
...
#End Region
    ...
    Private Sub tscbZoom_Click(sender As System.Object, e As System.EventArgs) Handles tscbZoom.Click

    End Sub

    Private Sub tsWidth_Click(sender As System.Object, e As System.EventArgs) Handles tsWidth.Click
        ApplyZoom(ViewMode.FIT_WIDTH)
        CenterPicBoxInPanel(FindPictureBox("SinglePicBox"))
        DisplayCurrentPage()
    End Sub

    Private Sub tsHeight_Click(sender As System.Object, e As System.EventArgs) Handles tsHeight.Click
        ApplyZoom(ViewMode.FIT_TO_SCREEN)
        CenterPicBoxInPanel(FindPictureBox("SinglePicBox"))
        DisplayCurrentPage()
    End Sub
